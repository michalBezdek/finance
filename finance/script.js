...
if (inČas === "6 mesicu" ) {
    ...
    function vypocetDPH(){
        ...
        let vysledek = noDPH * 1.21;
            document.getElementById("pap").innerHTML =  vysledek;
            
          
    }
 
             function vypocetDPH2(){
         let inDPH = parseFloat(document.getElementById("DPH").value);
                let result = inDPH / 1.21;
            document.getElementById("pip").innerHTML =  result;  
            }